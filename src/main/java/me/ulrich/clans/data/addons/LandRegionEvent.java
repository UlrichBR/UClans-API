...
public abstract class LandRegionEvent extends PlayerEvent {
    private static final HandlerList handlerList = new HandlerList();
    private IslandJoinLeaveData region;
    private MovementWay movement;
    public PlayerEvent parentEvent;

    public LandRegionEvent(IslandJoinLeaveData region, Player player, MovementWay movement, PlayerEvent parent) {
        super(player);
        this.region = region;
